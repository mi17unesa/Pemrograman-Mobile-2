...
class ScientificActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvSin.setOnClickListener { appendOnExpresstion("sin", false) }
        tvCos.setOnClickListener { appendOnExpresstion("cos", false) }
        tvTan.setOnClickListener { appendOnExpresstion("tan", false) }
        tvLog.setOnClickListener { appendOnExpresstion("log", false) }
        tvMod.setOnClickListener { appendOnExpresstion("mod", false) }
